 ...
 * linear finite volume advection-diffusion boundary conditions.
 */
class SideLinearFVFluxBCIntegral : public SideIntegralPostprocessor
{
public:
  static InputParameters validParams();
  virtual void initialSetup() override;

  SideLinearFVFluxBCIntegral(const InputParameters & parameters);
...
protected:
  ...
  std::vector<LinearFVAdvectionDiffusionBC *> _bc_objects;
};
